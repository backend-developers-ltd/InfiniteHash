...
- During installation, if `proxy/pools.toml` does not exist yet, the script asks for backup/private pool host/port/worker ID and writes those values to `pools.backup`.
